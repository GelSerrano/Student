...
public class final_quiz15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("F_Q15SharedPref",MODE_PRIVATE);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        myEdit.putString("fq15_date","Q15 " + currdate);
                        myEdit.putInt("fq15_score", correct);
                        myEdit.commit();
