...
public class midterm_quiz10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("M_Q10SharedPref",MODE_PRIVATE);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("lesson10");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        myEdit.putString("mq10_date","Q10 " + currdate);
                        myEdit.putInt("mq10_score", correct);
                        myEdit.commit();
