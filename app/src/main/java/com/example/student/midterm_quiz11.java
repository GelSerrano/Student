...
public class midterm_quiz11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("M_Q11SharedPref",MODE_PRIVATE);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("lesson11");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //Question5
                final Question five = dataSnapshot.child("MidtermTrueOrFalse").child(tf.get(0)).getValue(Question.class);
                ...
                //Question6
                final Question six = dataSnapshot.child("MidtermTrueOrFalse").child(tf.get(1)).getValue(Question.class);
                ...
                //Question7
                final Question seven = dataSnapshot.child("MidtermTrueOrFalse").child(tf.get(2)).getValue(Question.class);
                ...
                //Question8
                final Question eight = dataSnapshot.child("MidtermIdentification").child(ident.get(0)).getValue(Question.class);
                question8.setText(eight.getQuestion());

                //Question9
                final Question nine = dataSnapshot.child("MidtermIdentification").child(ident.get(1)).getValue(Question.class);
                question9.setText(nine.getQuestion());

                //Question10
                final Question ten = dataSnapshot.child("MidtermIdentification").child(ident.get(2)).getValue(Question.class);
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        myEdit.putString("mq11_date","Q11 " + currdate);
                        myEdit.putInt("mq11_score", correct);
                        myEdit.commit();
...
//        reverseTimer(120, timer);
//
//        databaseReference = FirebaseDatabase.getInstance().getReference().child("x`Question").child("lesson1");
//        databaseReference.keepSynced(true);
//        databaseReference.addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
