...
public class Frag_prelim extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sh1  = this.getActivity().getSharedPreferences("P_Q1SharedPref", MODE_PRIVATE);
        String pquiz1_date = sh1.getString("pq1_date", "");

        sh2 = this.getActivity().getSharedPreferences("P_Q2SharedPref", MODE_PRIVATE);
        String pquiz2_date = sh2.getString("pq2_date", "");

        sh3 = this.getActivity().getSharedPreferences("P_Q3SharedPref", MODE_PRIVATE);
        String pquiz3_date = sh3.getString("pq3_date", "");

        sh4 = this.getActivity().getSharedPreferences("P_Q4SharedPref", MODE_PRIVATE);
        String pquiz4_date = sh4.getString("pq4_date", "");

        sh5 = this.getActivity().getSharedPreferences("P_Q5SharedPref", MODE_PRIVATE);
...
//customization
        LineChart mLineGraph =  view.findViewById (R.id.linechart);
