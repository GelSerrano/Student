...
public class prelim_quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("P_Q4SharedPref",MODE_PRIVATE);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("lesson4");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        myEdit.putString("pq4_date", "Q(4) " + currdate);
                        myEdit.putInt("pq4_score", correct);
                        myEdit.commit();
