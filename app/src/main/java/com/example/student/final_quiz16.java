...
public class final_quiz16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("F_Q16SharedPref",MODE_PRIVATE);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("lesson16");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        myEdit.putString("fq16_date","Q16 " + currdate);
                        myEdit.putInt("fq16_score", correct);
                        myEdit.commit();
