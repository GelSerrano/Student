...
public class final_quiz14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("F_Q14SharedPref",MODE_PRIVATE);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        myEdit.putString("fq14_date","Q14 " + currdate);
                        myEdit.putInt("fq14_score", correct);
                        myEdit.commit();
